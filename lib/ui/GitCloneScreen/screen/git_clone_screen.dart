...
// data variables
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<GitCloneBloc, GitCloneState>(
      bloc: bloc,
      builder: (context, state) {
        ...
        if (state is GitCloneInitialState) {
          _urlController.text = "";
          _passwordController.text = state.defaultId ?? "";
          _userNameController.text = state.defaultName ?? "";
          _userEmailController.text = state.defaultEmail ?? "";
        }
        return Scaffold(
          appBar: AppBar(),
          body: Center(
